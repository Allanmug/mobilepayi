"""
Django settings for mobilepay project.
...
SECRET_KEY = 'django-insecure-hsz7-eeg(o3)m#u3gjbqm!$%=pe*i%hfqgxi0@d4uxvc$9o%$s'
...
WSGI_APPLICATION = 'mobilepay.wsgi.application'
...
# Add the Airtel credentials
AIRTEL_CLIENT_ID = os.getenv('391ec4efc775-3552-4836-81ea-a5bcc97ce806')
